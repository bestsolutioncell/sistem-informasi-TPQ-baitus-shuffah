      ...
      items: [
        {
          ...
          href: `/dashboard/${user?.role?.toLowerCase()}/reports/executive`,
          icon: TrendingUp,
          roles: ['ADMIN']
        },
        {
          name: 'Comprehensive Reports',
          href: `/dashboard/${user?.role?.toLowerCase()}/reports/comprehensive`,
          icon: FileText,
          roles: ['ADMIN', 'MUSYRIF']
        },
        {
          name: 'Performance Metrics',
          href: `/dashboard/${user?.role?.toLowerCase()}/reports/metrics`,
          icon: Target,
          roles: ['ADMIN', 'MUSYRIF']
        },
        {
